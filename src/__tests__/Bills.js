...
describe('Given I am connected as an employee', () => {
  ...
  afterEach(() => {
    ...
    test('should navigate to new bill page when new bill button is clicked', () => {
      fireEvent.click(screen.getByTestId('btn-new-bill'));
      expect(onNavigate).toHaveBeenCalledWith(ROUTES_PATH['NewBill']);
    });


    test('should open modal when eye icon is clicked', () => {
      $.fn.modal = jest.fn(); 
  ...
  describe('Bills', () => {
    test('should get bills correctly', async () => {
